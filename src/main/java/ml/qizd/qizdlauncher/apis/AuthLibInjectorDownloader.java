...
public class AuthLibInjectorDownloader {
    private static final String URL = "https://github.com/yushijinhun/authlib-injector/releases/download/v1.2.3/authlib-injector-1.2.3.jar";
    public static final String INJECTOR_FILE = "authlib-injector-1.2.3.jar";
